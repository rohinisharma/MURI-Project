...
import sys
sys.path.append('/Users/rohinisharma/Projects/MURIproj/models')
...
class Imagenet16Model(imagenet_main.ImagenetModel):
    def __init__(self, resnet_size, data_format=None, num_classes=17):
...
def resnet_model_fn(features, labels, mode, model_class,
    ...
    mean_per_class_accuracy = tf.metrics.mean_per_class_accuracy(
        tf.argmax(labels, axis=1), predictions['classes'], 17, weights=weights)
